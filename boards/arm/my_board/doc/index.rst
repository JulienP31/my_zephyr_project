...
The Zephyr my_board board configuration supports the following hardware features:
...
``boards/arm/my_board/my_board_defconfig``
...
Board connectors:
-----------------
.. image:: img/my_board_connectors.png
   :width: 800px
   :align: center
   :height: 619px
...
Applications for the ``my_board`` board configuration can be built and
